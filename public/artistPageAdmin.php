    ...
    <table>
        ...
        <?php foreach ($songs as $index => $row): ?>
            <tr>
                ...
                <td>
                    <a href="http://localhost:81/indSongAdmin.php?songid=<?php echo $row['song_id']; ?>&userid=2"><?php echo $row['song_title']; ?></a>
                </td>
    ...
    <table>
        ...
        <?php foreach ($albums as $index => $row): ?>
            <tr>
                <!-- link allows you to pass id to next page -->
                <td>
                    <a href="http://localhost:81/indAlbumAdmin.php?albumid=<?php echo $row['album_id']; ?>&userid=2"><?php echo $row['album_title']; ?></a>
                </td>
